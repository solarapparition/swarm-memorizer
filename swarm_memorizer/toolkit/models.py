...
PRECISE_MODEL = ChatOpenAI(temperature=0, model_name="gpt-4-turbo-preview", verbose=False)  # type: ignore
...
SUPER_CREATIVE_MODEL = ChatOpenAI(temperature=1.0, model_name="gpt-4-turbo-preview", verbose=False)  # type: ignore
